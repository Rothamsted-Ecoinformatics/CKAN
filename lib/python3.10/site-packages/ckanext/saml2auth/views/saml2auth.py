...
#    if(auth_response.ava):
#        logging.warning('im bloody here')
#        logging.warning(auth_response.ava['http://schemas.xmlsoap.org/ws/2005/05/identity/claims/email'])
#    else: 
#        logging.warning('got nothing')
    ...
    if saml_user_firstname and saml_user_lastname:
        ...
        logging.warning(auth_response.ava.get(saml_user_firstname, [email.split('@')[0]]))
...
#    logging.warning(saml_user_email)
#    logging.warning(saml_id)
#    logging.warning(saml_user_fullname)
#    logging.warning(auth_response.ava)
